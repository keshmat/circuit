...
drop policy if exists "Allow public to read registration settings" on registration_settings;
drop policy if exists "Allow authenticated users to update registration settings" on registration_settings;
